...
function Servicehero() {
  return (
    ...
    <div className=' sm:hidden'>
            <div className='bg-no-repeat bg-cover h-auto sm:h-[87vh] first-line:' style={{backgroundImage: `url(${servicebg})`}}>
                <div className='bg-no-repeat bg-cover h-[87vh] sm:h-[90vh] bg-opacity-50' style={{backgroundImage: `url(${otherbg})`}}>
